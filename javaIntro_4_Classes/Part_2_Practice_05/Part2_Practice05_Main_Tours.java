...
public class Part2_Practice05_Main_Tours {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please, select a tour options:");
		System.out.println("Choose a tour type (you can choose one or more options):"
				+ "\n(1) Vacation"
				+ "\n(2) Cruise"
				+ "\n(3) Excurtions"
				+ "\n(4) Therapy"
		...
		System.out.println(type.equals(tours.get(0).getType()));
		...
		System.out.print("Enter a tour duration diapazon: ");
